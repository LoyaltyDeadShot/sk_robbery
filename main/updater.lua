...
local resourceName = "sk_robbery"


CreateThread(function()
    if GetCurrentResourceName() ~= "sk_robbery" then
        resourceName = "sk_robbery (" .. GetCurrentResourceName() .. ")"
    end
end)
CreateThread(function()
    while true do
        PerformHttpRequest("https://api.github.com/repos/Skull-Code/sk_robbery/releases/latest", CheckVersion, "GET")
        Wait(3600000)
    end
end)
...
function GetRepoInformations()
    ...
    PerformHttpRequest("https://api.github.com/repos/Skull-Code/sk_robbery/releases/latest", function(err, response)
        if err == 200 then
            ...
            repoURL = "https://github.com/Skull-Code/sk_robbery"
        end
    end, "GET")
    repeat
        Wait(50)
